...
Библиотека для генерации криптографически защищенных паролей/токенов и других наборов и последовательностей с проверкой надежности паролей и многоязычной поддержкой.
